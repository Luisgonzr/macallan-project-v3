...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  formatMonthExpiry = function(e) {
	    ...
	    if (/^\d$/.test(val) && (val !== '0' && val !== '1')) {
	      e.preventDefault();
	      QJ.val(target, val);//QJ.val(target, "0" + val);LGO
	      return QJ.trigger(target, 'change');
	    } else if (/^\d\d$/.test(val)) {
	      e.preventDefault();
	      QJ.val(target, val); //QJ.val(target, "" + val);LGO
	      return QJ.trigger(target, 'change');
	    }
	  };
	  ...
	  Payment = (function() {
	    ...
	    Payment.formatCardExpiryMultiple = function(month, year) {
	      //QJ.on(month, 'keypress', restrictMonthExpiry);LGO
	      //QJ.on(month, 'keypress', formatMonthExpiry);LGO
	      //return QJ.on(year, 'keypress', restrictYearExpiry);LGO
	    };
